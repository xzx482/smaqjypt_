...
'''
	...
	if(not 专题id):
		try:
			数据_=json.loads(访问("https://xzx482.github.io/smaqjypt_/%E6%95%B0%E6%8D%AE/%E4%B8%93%E9%A2%98id%E8%A1%A8.json")[6])
		except:
			try:
				数据_=json.loads(访问("https://raw.githubusercontent.com/xzx482/smaqjypt_/main/%E6%95%B0%E6%8D%AE/%E4%B8%93%E9%A2%98id%E8%A1%A8.json")[6])
			except:
				return 0
		try:
			专题id=数据_[str(作业id)]
...
'''
	...
	if(specialId in 专题数据):
		...
		#try:''
			...
			try:
				数据=json.loads(访问("https://xzx482.github.io/smaqjypt_/%E6%95%B0%E6%8D%AE/"+specialId+".json")[6])
			except:
				try:
					数据=json.loads(访问("https://raw.githubusercontent.com/xzx482/smaqjypt_/main/%E6%95%B0%E6%8D%AE/"+specialId+".json")[6])
				except:
					if(not 安静模式):
						print('获取失败')
					return 0
...
if __name__ == '__main__':
	try:
		...
		版本更新_获取=None
		try:
			版本更新_获取=request.urlopen("https://xzx482.github.io/smaqjypt_/%E6%95%B0%E6%8D%AE/%E6%9C%80%E6%96%B0%E7%89%88%E6%9C%AC.json",timeout=8)
